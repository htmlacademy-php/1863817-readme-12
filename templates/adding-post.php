              ...
              <form class="adding-post__form form dropzone" action="/add.php" method="post" enctype="multipart/form-data" autocomplete="off">
                <div class="form__text-inputs-wrapper">
                  <div class="form__text-inputs">
                    <div class="adding-post__input-wrapper form__input-wrapper <?= isset($_GET['resultHeading']) ? 'form__input-section--error' : ''; ?>">
                      ...
                      <div class="form__input-section">
                        ...
                        <div class="form__error-text">
                          ...
                          <p class="form__error-desc"><?= isset($_GET['resultHeading']) ? $_GET['resultHeading'] : ''; ?></p>
                        </div>
                      </div>
                    </div>
                    <div class="adding-post__input-wrapper form__input-wrapper <?= isset($_GET['resultLink']) ? 'form__input-section--error' : ''; ?>">
                      ...
                      <div class="form__input-section">
                        ...
                        <div class="form__error-text">
                          <h3 class="form__error-title">Ошибка при заполнении поля</h3>
                          <p class="form__error-desc"><?= isset($_GET['resultLink']) ? $_GET['resultLink'] : ''; ?></p>
                        </div>
                      </div>
                    </div>
                    <div class="adding-post__input-wrapper form__input-wrapper <?= isset($_GET['resultTags']) ? 'form__input-section--error' : ''; ?>">
                      ...
                      <div class="form__input-section">
                        ...
                        <div class="form__error-text">
                          <h3 class="form__error-title">Ошибка при заполнении поля</h3>
                          <p class="form__error-desc"><?= isset($_GET['resultTags']) ? $_GET['resultTags'] : ''; ?></p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <?php elseif ($_GET['filter'] === 'text') : ?>
            <section class="adding-post__text tabs__content tabs__content--active">
              ...
              <form class="adding-post__form form" action="/add.php" method="post" enctype="multipart/form-data" autocomplete="off">
                <div class="form__text-inputs-wrapper">
                  <div class="form__text-inputs">
                    <div class="adding-post__input-wrapper form__input-wrapper <?= isset($_GET['resultHeading']) ? 'form__input-section--error' : null; ?>">
                    ...
                    <div class="adding-post__textarea-wrapper form__textarea-wrapper <?= isset($_GET['resultText']) ? 'form__input-section--error' : null; ?>">
                      ...
                      <div class="form__input-section">
                        ...
                        <div class="form__error-text">
                          <h3 class="form__error-title">Ошибка при заполнении поля</h3>
                          <p class="form__error-desc"><?= isset($_GET['resultText']) ? $_GET['resultText'] : ''; ?></p>
                        </div>
                      </div>
                    </div>
                    <div class="adding-post__input-wrapper form__input-wrapper <?= isset($_GET['resultTags']) ? 'form__input-section--error' : null; ?>">
              ...
              <form class="adding-post__form form" action="/add.php" method="post" enctype="multipart/form-data" autocomplete="off">
                <div class="form__text-inputs-wrapper">
                  <div class="form__text-inputs">
                    ...
                    <div class="adding-post__input-wrapper form__textarea-wrapper <?= isset($_GET['resultText']) ? 'form__input-section--error' : ''; ?>">
                    ...
                    <div class="adding-post__textarea-wrapper form__input-wrapper <?= isset($_GET['resultAuthor']) ? 'form__input-section--error' : ''; ?>">
                      ...
                      <div class="form__input-section">
                        ...
                        <div class="form__error-text">
                          <h3 class="form__error-title">Ошибка при заполнении поля</h3>
                          <p class="form__error-desc"><?= isset($_GET['resultAuthor']) ? $_GET['resultAuthor'] : ''; ?></p>
                        </div>
                      </div>
                    </div>
                    <div class="adding-post__input-wrapper form__input-wrapper <?= isset($_GET['resultTags']) ? 'form__input-section--error' : ''; ?>">
                    ...
                    <div class="form__invalid-block">
                      ...
                      <ul class="form__invalid-list">
                        ...
                        <?php if (isset($_GET['resultText'])) : ?>
                          <li class="form__invalid-item">Текст поста. <?= $_GET['resultText'] ?></li>
                        <?php endif; ?>
                        <?php if (isset($_GET['resultAuthor'])) : ?>
              ...
              <form class="adding-post__form form" action="/add.php" method="post" enctype="multipart/form-data" autocomplete="off">
                <div class="form__text-inputs-wrapper">
                  <div class="form__text-inputs">
                    ...
                    <div class="adding-post__textarea-wrapper form__input-wrapper <?= isset($_GET['resultLink']) ? 'form__input-section--error' : ''; ?>">
